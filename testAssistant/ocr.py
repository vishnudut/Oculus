...
def speak(audio_string):
	...
	audio_file = "audio file"+ str(r) + '.mp3'
	tts.save(audio_file)
...
def img_to_text(filename,preprocess="thresh"):
	print("inside ocr file")
	imagePaths = cv2.imread(filename)
	gray = cv2.cvtColor(imagePaths, cv2.COLOR_BGR2GRAY)
